...
// In WASM MEMFS /tmp exists by default; the real device path from
// USERDATA TEMPDIR would need directory creation, so use /tmp directly.
#define DB_FILE "/tmp/demo07.sqlite3"
